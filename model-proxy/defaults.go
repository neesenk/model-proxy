...
providers:
  ...
  zhipu:
    ...
    models:
      ...
      glm-5.1:     {context: 128000, output: 4096, modalities: {input: [text], output: [text]}}
      glm-5:       {context: 128000, output: 4096, modalities: {input: [text], output: [text]}}
      glm-5-turbo: {context: 128000, output: 4096, modalities: {input: [text], output: [text]}}
      glm-4.7:     {context: 128000, output: 4096, modalities: {input: [text], output: [text]}}
      glm-4.6:     {context: 128000, output: 4096, modalities: {input: [text], output: [text]}}
      glm-4.5:     {context: 128000, output: 4096, modalities: {input: [text], output: [text]}}
      glm-4.5-air: {context: 128000, output: 4096, modalities: {input: [text], output: [text]}}
