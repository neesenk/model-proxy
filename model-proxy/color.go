...
// display methods); this file exposes only the wrappers used by root CLI
// composition and keeps the stderr LOG color helpers (cl, statusColor,
// logColorEnabled) here because they are log-stream-specific.
