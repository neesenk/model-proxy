...
func internalRepositoryImportPolicy() map[string]map[string]bool {
	return map[string]map[string]bool{
		...
		"model-proxy/internal/cli/framework":         {"model-proxy/internal/config": true},
		"model-proxy/internal/cli/login":             {"model-proxy/internal/accounts": true, "model-proxy/internal/cli/framework": true, "model-proxy/internal/config": true, "model-proxy/provider": true},
		"model-proxy/internal/cli/models":            {"model-proxy/internal/cli/serve": true, "model-proxy/internal/cli/framework": true, "model-proxy/internal/accounts": true, "model-proxy/internal/app": true, "model-proxy/internal/catalog": true, "model-proxy/internal/config": true, "model-proxy/internal/probe": true, "model-proxy/provider": true},
		"model-proxy/internal/cli":                   {"model-proxy/internal/cli/serve": true, "model-proxy/internal/cli/framework": true, "model-proxy/internal/accounts": true, "model-proxy/internal/app": true, "model-proxy/internal/cli/login": true, "model-proxy/internal/cli/models": true, "model-proxy/internal/config": true, "model-proxy/internal/daemonctl": true, "model-proxy/internal/observe/requestlog": true, "model-proxy/internal/observe/stats": true, "model-proxy/provider": true},
		...
		"model-proxy/internal/app":                   {"model-proxy/internal/accounts": true, "model-proxy/internal/catalog": true, "model-proxy/internal/config": true, "model-proxy/internal/protocol": true, "model-proxy/provider": true},
		...
		"model-proxy/internal/web":                   {"model-proxy/internal/appapi": true, "model-proxy/internal/observe/requestlog": true, "model-proxy/internal/pricing": true},
	}
}
