...
func internalRepositoryImportPolicy() map[string]map[string]bool {
	return map[string]map[string]bool{
		...
		"model-proxy/internal/cli/login":             {"model-proxy/provider": true},
		...
		"model-proxy/internal/cli":                   {"model-proxy/internal/daemonctl": true, "model-proxy/internal/observe/stats": true, "model-proxy/provider": true},
		...
		"model-proxy/internal/app":                   {"model-proxy/internal/accounts": true, "model-proxy/internal/catalog": true, "model-proxy/internal/config": true, "model-proxy/provider": true},
