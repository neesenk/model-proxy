...
func TestConvertGap_CodexStripsUnsupportedParams(t *testing.T) {
	...
	out, err := convertRequestFor([]byte(in), "anthropic", "responses", convertReqOpts{ProviderID: "codex", ImageOK: true})
	if err != nil {
	...
	out2, err := convertRequestFor([]byte(in), "anthropic", "responses", convertReqOpts{ProviderID: "qwen-plan", ImageOK: true})
	if err != nil {
