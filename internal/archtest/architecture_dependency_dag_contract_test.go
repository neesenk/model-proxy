...
func internalRepositoryImportPolicy() map[string]map[string]bool {
	return map[string]map[string]bool{
		...
		"model-proxy/internal/cli/models":    {"model-proxy/internal/display": true, "model-proxy/internal/cli/serve": true, "model-proxy/internal/cli/framework": true, "model-proxy/internal/accounts": true, "model-proxy/internal/catalog": true, "model-proxy/internal/config": true, "model-proxy/internal/configedit": true, "model-proxy/internal/probe": true, "model-proxy/internal/provider": true, "model-proxy/internal/providerbuild": true, "model-proxy/internal/routing": true, "model-proxy/internal/runtime/wirecap": true},
		...
		"model-proxy/internal/cli/diag":      {"model-proxy/internal/cli/framework": true, "model-proxy/internal/cli/models": true, "model-proxy/internal/config": true, "model-proxy/internal/daemonctl": true, "model-proxy/internal/display": true, "model-proxy/internal/observe/requestlog": true, "model-proxy/internal/probe": true, "model-proxy/internal/provider": true},
