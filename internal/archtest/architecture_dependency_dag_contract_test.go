...
func internalRepositoryImportPolicy() map[string]map[string]bool {
	return map[string]map[string]bool{
		...
		"model-proxy/internal/cli":                   {"model-proxy/internal/cli/serve": true, "model-proxy/internal/cli/framework": true, "model-proxy/internal/accounts": true, "model-proxy/internal/app": true, "model-proxy/internal/appapi": true, "model-proxy/internal/cli/clicommon": true, "model-proxy/internal/cli/doctor": true, "model-proxy/internal/cli/login": true, "model-proxy/internal/cli/models": true, "model-proxy/internal/cli/presets": true, "model-proxy/internal/config": true, "model-proxy/internal/daemonctl": true, "model-proxy/internal/takeover": true, "model-proxy/internal/observe/requestlog": true, "model-proxy/internal/observe/seclog": true, "model-proxy/internal/observe/stats": true, "model-proxy/internal/provider": true},
		"model-proxy/internal/cli/presets":           {"model-proxy/internal/cli/framework": true, "model-proxy/internal/cli/login": true, "model-proxy/internal/cli/serve": true, "model-proxy/internal/config": true, "model-proxy/internal/provider": true, "model-proxy/internal/presets": true},
		...
		"model-proxy/internal/observe/seclog":        nil,
		...
		"model-proxy/internal/web":     {"model-proxy/internal/appapi": true, "model-proxy/internal/observe/requestlog": true, "model-proxy/internal/observe/stats": true, "model-proxy/internal/pricing": true, "model-proxy/internal/webauth": true},
