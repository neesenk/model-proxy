...
func internalRepositoryImportPolicy() map[string]map[string]bool {
	return map[string]map[string]bool{
		...
		"model-proxy/internal/catalog":       {"model-proxy/internal/upstreamproxy": true},
		...
		"model-proxy/internal/adjudicate":    nil,
		...
		"model-proxy/internal/cli/mcp":       {"model-proxy/internal/accounts": true, "model-proxy/internal/cli/framework": true, "model-proxy/internal/config": true, "model-proxy/internal/display": true, "model-proxy/internal/mcp": true, "model-proxy/internal/provider": true, "model-proxy/internal/providerbuild": true, "model-proxy/internal/upstreamproxy": true},
		"model-proxy/internal/cli/models":    {"model-proxy/internal/display": true, "model-proxy/internal/cli/serve": true, "model-proxy/internal/cli/framework": true, "model-proxy/internal/accounts": true, "model-proxy/internal/catalog": true, "model-proxy/internal/config": true, "model-proxy/internal/configedit": true, "model-proxy/internal/probe": true, "model-proxy/internal/provider": true, "model-proxy/internal/providerbuild": true, "model-proxy/internal/routing": true, "model-proxy/internal/runtime/wirecap": true, "model-proxy/internal/upstreamproxy": true},
		"model-proxy/internal/cli": {
			...
			"model-proxy/internal/cli/guard": true,
			"model-proxy/internal/cli/diag":  true, "model-proxy/internal/cli/doctor": true,
			"model-proxy/internal/cli/login": true, "model-proxy/internal/cli/mcp": true, "model-proxy/internal/cli/models": true,
		...
		"model-proxy/internal/cli/guard":     {"model-proxy/internal/appapi": true, "model-proxy/internal/cli/framework": true, "model-proxy/internal/config": true, "model-proxy/internal/daemonctl": true, "model-proxy/internal/display": true},
		"model-proxy/internal/cli/diag":      {"model-proxy/internal/cli/framework": true, "model-proxy/internal/cli/models": true, "model-proxy/internal/config": true, "model-proxy/internal/daemonctl": true, "model-proxy/internal/display": true, "model-proxy/internal/observe/requestlog": true, "model-proxy/internal/probe": true, "model-proxy/internal/provider": true, "model-proxy/internal/upstreamproxy": true},
		...
		"model-proxy/internal/observe/requestlog":    {"model-proxy/internal/config": true, "model-proxy/internal/observe/logfile": true, "model-proxy/internal/observe/logx": true},
		"model-proxy/internal/observe/seclog":        {"model-proxy/internal/observe/logfile": true, "model-proxy/internal/observe/logx": true},
		"model-proxy/internal/observe/stats":         {"model-proxy/internal/observe/counters": true, "model-proxy/internal/observe/logx": true},
		"model-proxy/internal/pricing":               {"model-proxy/internal/upstreamproxy": true},
		...
		"model-proxy/internal/app": {
			...
			"model-proxy/internal/adjudicate": true,
			"model-proxy/internal/cache":      true, "model-proxy/internal/catalog": true,
			...
			"model-proxy/internal/mcp":              true,
			"model-proxy/internal/observe/counters": true, "model-proxy/internal/observe/events": true,
			"model-proxy/internal/observe/budget":     true,
			"model-proxy/internal/observe/logx":       true,
			"model-proxy/internal/observe/requestlog": true, "model-proxy/internal/observe/seclog": true, "model-proxy/internal/observe/stats": true,
			"model-proxy/internal/pricing": true, "model-proxy/internal/probe": true,
			...
			"model-proxy/internal/display": true, "model-proxy/internal/provider": true, "model-proxy/internal/providerbuild": true,
		},
		"model-proxy/internal/appapi":  {"model-proxy/internal/adjudicate": true, "model-proxy/internal/fusion": true, "model-proxy/internal/observe/requestlog": true, "model-proxy/internal/observe/stats": true, "model-proxy/internal/presets": true, "model-proxy/internal/pricing": true},
