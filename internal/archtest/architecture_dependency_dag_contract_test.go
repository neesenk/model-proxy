...
func internalRepositoryImportPolicy() map[string]map[string]bool {
	return map[string]map[string]bool{
		...
		"model-proxy/internal/config":        {"model-proxy/internal/catalog": true, "model-proxy/internal/pricing": true, "model-proxy/internal/protocol": true, "model-proxy/internal/upstreamproxy": true},
